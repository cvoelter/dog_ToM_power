---
title: "Study 4 - binomial GLM  - Power analysis"
...
tb.per <- c(0.30, 0.5) # performance in tb condition
...
save.image("power_sim_study4_N72.RData")
```
...
ggsave(p.con.power, filename = "single_breed_simulation_N72.png", scale = 0.8, height = 5, width = 7)
```